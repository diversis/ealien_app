...
export default function Carousel({ children, breakpoints, autoplayDelay }: {
  children: ReactNode[], breakpoints?: {
  ...
  return (
    <m.section ref={ref} className="w-full">
      <Swiper
        ...
        autoplay={{ delay: autoplayDelay ? autoplayDelay : 5000 }}
          ...
          return (
            ...
            >
              <m.div
                ...
                exit="exit"
                className="grid h-full w-full  max-h-full max-w-full place-items-center relative"
              >
                {child}
              </m.div>
            </SwiperSlide>
