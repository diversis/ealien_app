...
export default function ProductCard({
    ...
    return (
        <m.div
            ...
            exit="hidden"
            className="z-0 aspect-square w-full max-w-[24rem] transform-none place-self-center transition-[z-index] duration-500 ease-[cubic-bezier(1,0,1,0)] [&:is(:hover,:focus,:focus-within)]:z-[100] [&:is(:hover,:focus,:focus-within)]:duration-0"
        >
